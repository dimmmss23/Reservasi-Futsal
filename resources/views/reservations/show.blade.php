                        ...
                        <div class="bg-slate-900 rounded-lg p-6">
                            <div class="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <span class="inline-block px-4 py-2 rounded-full text-xs font-bold {{ $reservation->paymentDetail->status_badge_class }} border">
                                        {{ ucfirst($reservation->paymentDetail->status) }}
                                    </span>
                                </div>
                                <div>
