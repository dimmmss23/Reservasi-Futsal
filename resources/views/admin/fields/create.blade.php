...
@section('page-subtitle', 'Create a new futsal field')
...
<div class="max-w-3xl">
    ...
    <div class="bg-gray-900 rounded-lg border-2 border-gray-800 p-8">
        <form method="POST" action="{{ route('admin.fields.store') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <select id="type" 
                    ...
                    <option value="Sintetis" {{ old('type') === 'Sintetis' ? 'selected' : '' }}>Sintetis (Synthetic Grass)</option>
            ...
            <div>
                ...
                <textarea id="description" 
                          ...
                          placeholder="Describe the field features, facilities, etc.">{{ old('description') }}</textarea>
                @error('description')
                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
                ...
                <div class="relative">
                    ...
                    <label for="image" 
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-gray-400 mb-1">Click to upload field image</p>
